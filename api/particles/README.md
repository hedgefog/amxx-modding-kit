...
## ⚙️ Registering a New Particle Effect
...
## 🗑️ Removing the Particle Effect System
...
See [`api_particles.inc`](include/api_particles.inc) and [`api_particles_const.inc`](include/api_particles_const.inc) for all available natives and constants.
